...
interface ModalPlantaCategory {
    options: PlantaProps[];
    handleCloseModal: () => void;
    selectedItem: (item: PlantaProps) => void;
}

const { width: WIDTH , height: HEIGHT } = Dimensions.get('window');

export function ModalClassPlant({options, handleCloseModal, selectedItem}: ModalPlantaCategory){

    function onPressItem(item: PlantaProps){     
        console.log(item);
        selectedItem(item);
        handleCloseModal();
    }
